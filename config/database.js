...
// ++Render Backend Database Connection Setup++
//           !
//           !
...
//     logging: false
//   });
//   console.log('Using PostgreSQL database from Render');
// } else {
...
//     if (isProduction || process.env.DATABASE_URL) {
//       return { status: 'disconnected', message: `PostgreSQL connection failed: ${error.message}` };
//     } else {
//       const unknownDatabaseError = error.original && 
//         (error.original.code === 'ER_BAD_DB_ERROR' || error.original.errno === 1049);
